...
This package is at version `0.0.1-pre`. It contains no functional code, only the package
structure that will host the SDK. Do not install for production use yet.
